...
void ofApp::setup(){
	...
	buttons->add<ofxGuiButton>("image button (scale)", ofJson({{"type", "fullsize"}, {"padding", "20"}, {"background-image", "images/ente.png"}, {"background-size", "scale"}}));
	buttons->add<ofxGuiButton>("image button (cover)", ofJson({{"type", "fullsize"}, {"padding", "20"}, {"background-image", "images/ente.png"}, {"background-size", "cover"}}));
	buttons->add<ofxGuiButton>("image button (contain)", ofJson({{"type", "fullsize"}, {"padding", "20"}, {"background-image", "images/ente.png"}, {"background-size", "contain"}}));
